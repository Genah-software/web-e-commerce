<?php 
	...
	$id = $_GET[q];
	$qa = mysqli_query($conn,"select * from corp");
                    ...
                    <div class="post-details-content mb-100">
                        <div class="single-blog-post style2 mb-50">
                            ...
                            <div class="blog-content">
                                <h4><?php echo corp($p=$_GET[pages]); ?></h4>
                               
                                <p><?php if($p=='1'){ echo $ra[visimisi];}elseif($p=='2'){ echo $ra[sejarah];}else{ echo $ra[penghargaan];}?></p>
                            </div>
                        </div>
                    </div>
