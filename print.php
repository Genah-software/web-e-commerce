...
<?php 
	$id=$_GET[q];
	$qmtr = mysqli_query($conn,"select * from motor where id='$id'");
...
<table class="table col-lg-6">
	...
	<tr>
		<td>Type Motor</td>
		<td>:</td>
		<td><input type="text" name="a17" placeholder="Type motor" class="form-control"></td>
	</tr>
	<tr>
		<td>DP Bayar</td>
		<td>:</td>
	...
	<tr>
		<td>Tenor</td>
		<td>:</td>
		<td><input type="text" name="a19" placeholder="Tenor" required class="form-control"></td>
	</tr>
	<tr>
...
<?php
	if($_POST[save]=='1'){
		...
		mysqli_query($conn,"INSERT INTO `db_kphonda`.`pemesan` (`id`, `nama_pemohon`, `ttl_pemohon`, `ibu_kandung_pemohon`, `ktp_pemohon`, `kk`, `slip_gaji`, `penjamin`, `ttl_penjamin`, `ibu_kandung_penjamin`, `ktp2`, `alamat`, `rt`, `rw`, `kelurahan`, `kecamatan`, `no_hp`, `type_motor`, `dp`, `tenor`) 
